  ...
  return (
    <div className="relative">
      <button
        ...
        className="relative flex size-8 items-center justify-center rounded-full hover:bg-muted"
      ...
      {isOpen && (
        <>
          ...
          />
          <div className="absolute end-0 z-50 mt-2 w-80 rounded-lg border bg-popover p-2 text-popover-foreground shadow-md">
